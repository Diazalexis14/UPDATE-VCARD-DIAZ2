...
export default function App() {
  ...
  <div className="App">
      <img 
        src="https://scontent.xx.fbcdn.net/v/t1.15752-9/438271692_767431772163548_3436415266645437429_n.jpg?stp=dst-jpg_s206x206&_nc_cat=105&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeEerQeB-dh8jUoVW3tDhpmJl3CeWk5jI1iXcJ5aTmMjWNTGjdiU1JYEXoUmsL7xbp_AQ6B7ngyiDn-fGGMhN5iw&_nc_ohc=ZrK3jS2rVskQ7kNvgFXSyGd&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_Q7cD1QF6DsVu3B4u574IWF4zVMLG2eQR-tWmnJVxjxG2DOBN0Q&oe=666AD206" 
        alt="Your Image" 
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
        style={{ 
          width: isHovered ? '150px' : '100px', // Adjust sizes as needed
          height: isHovered ? '150px' : '100px', // Adjust sizes as needed
